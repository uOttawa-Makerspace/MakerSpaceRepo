...
project_id = Rails.application.credentials[Rails.env.to_sym]&.airbrake&.project_id
project_key = Rails.application.credentials[Rails.env.to_sym]&.airbrake&.project_key
