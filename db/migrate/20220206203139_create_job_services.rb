class CreateJobServices < ActiveRecord::Migration[6.1]
  def change
    ...
    reversible do |change|
      change.up do
        JobService.create(name: 'Low Quality', required: false, job_service_group: JobServiceGroup.find_by(name: 'PLA'), unit: 'g', internal_price: 0.15, external_price: 0.3)
        JobService.create(name: 'Medium Quality', required: false, job_service_group: JobServiceGroup.find_by(name: 'PLA'), unit: 'g', internal_price: 0.2, external_price: 0.4)
        JobService.create(name: 'High Quality', required: false, job_service_group: JobServiceGroup.find_by(name: 'PLA'), unit: 'g', internal_price: 0.25, external_price: 0.5)
        JobService.create(name: 'Low Quality', required: false, job_service_group: JobServiceGroup.find_by(name: 'ABS'), unit: 'g', internal_price: 0.15, external_price: 0.3)
        JobService.create(name: 'Medium Quality', required: false, job_service_group: JobServiceGroup.find_by(name: 'ABS'), unit: 'g', internal_price: 0.2, external_price: 0.4)
        JobService.create(name: 'High Quality', required: false, job_service_group: JobServiceGroup.find_by(name: 'ABS'), unit: 'g', internal_price: 0.25, external_price: 0.5)
        ...
        JobService.create(name: 'M2 Onyx', required: true, job_service_group: JobServiceGroup.find_by(name: 'Markforged'), unit: 'cm3', internal_price: 0.53, external_price: 0.53)
        JobService.create(name: 'M2 Fiber Glass', required: false, job_service_group: JobServiceGroup.find_by(name: 'Markforged'), unit: 'cm3', internal_price: 5.82, external_price: 5.82)
        JobService.create(name: 'M2 Carbon Fiber', required: false, job_service_group: JobServiceGroup.find_by(name: 'Markforged'), unit: 'cm3', internal_price: 2.99, external_price: 2.99)
