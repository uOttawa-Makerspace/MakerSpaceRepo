...
class BadgesController < DevelopmentProgramsController
  before_action :only_admin_access, only: %i[admin certify new_badge grant_badge revoke_badge reinstate update_badge_templates update_badge_data]
  ...
  def grant_badge
    ...
    if badge.nil?
      badge_template = BadgeTemplate.find_by(id: params['badge']['badge_template_id'])
