...
class DevelopmentProgramsController < ApplicationController
  ...
  def join_development_program
    ...
    if program.save
      ...
      redirect_to root_path, alert: current_user.dev_program? ? "You already joined the Program. You can already access it!" : 'Something went wrong. Please try again later'
    end
  end
