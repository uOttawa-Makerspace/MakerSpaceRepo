...
document.getElementById("remove-link-list").addEventListener("click", function (event) {
...
document.getElementById("waiting-save-button").addEventListener("click", function (event) {
    let past_exp = document.getElementById("project_proposal_past_experiences");
    let past_exp_add = past_exp.value + "|";
    while (document.getElementsByClassName("main_ul")[0].lastChild){
        past_exp_add += document.getElementsByClassName("main_ul")[0].lastChild.lastChild.lastChild.value + ",";
        document.getElementsByClassName("main_ul")[0].removeChild(document.getElementsByClassName("main_ul")[0].lastChild);
    }
