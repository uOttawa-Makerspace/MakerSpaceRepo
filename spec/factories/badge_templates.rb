FactoryBot.define do
  factory :badge_template do
    trait :"3d_printing" do
      ...
      badge_description do
        "The badge earner has demonstrated their ability to understand and apply the basic rules for 3D printing an object, how to slice a 3D model and start a print on the machine. || Le porteur a démontré sa capacité à comprendre et à appliquer les règles de base lors de l’impression 3D d’un objet; comment trancher son modèle et l’utilisation de l’imprimante afin de réaliser son objet."
      end
      badge_name { "Beginner - 3D printing || Débutant - Impression 3D" }
      image_url do
        "https://images.youracclaim.com/images/1836ef76-cb9a-410b-bcea-97dcd0f2c3d4/1.png"
      end
    end
    ...
    trait :laser_cutting_no_id do
      ...
      badge_description do
        'The badge earner has demonstrated the basic skills needed for 2D modelling and to operate a laser cutter. || Le porteur de ce badge a démontré les compétences de base nécessaires pour la modélisation 2D et à l\'utilisation d\'une machine laser.'
      end
      badge_name { "Beginner Laser cutting || Beginner - Laser cutting" }
      image_url do
        "https://images.youracclaim.com/images/4561c296-f2dc-4b1e-b17b-19c4bb561a9e/4.png"
      end
    end
