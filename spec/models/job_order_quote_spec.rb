  ...
  describe "methods" do
    context "#total_price" do
      it 'should have the right total_price' do
        ...
        job_order_quote.job_order_quote_services = [create(:job_order_quote_service, per_unit: 7, quantity: 2)]
        job_order_quote.job_order_quote_options = [create(:job_order_quote_option, amount: 15)]
