  ...
  describe "methods" do
    context "#filter_by_attribute" do
      ...
      it "should get all the badges" do
        expect(
          Badge.joins(:badge_template).all.filter_by_attribute("search=").count
        ).to eq(Badge.all.count)
      end
      ...
      it "should get the searched badges" do
        expect(
          Badge
            .joins(:badge_template)
            .all
            .filter_by_attribute("search=2D modelling")
            .count
        ).to eq(1)
      end
    end
