  ...
  describe "POST /create" do
    ...
    context "logged as admin" do
      it "should create a requirement" do
        ...
        required_pp = create(:proficient_project)
        expect {
          post :create, params: { id: pp, required_project_id: required_pp.id }
      ...
      it "should fail to create a requirement" do
        ...
        required_pp = create(:proficient_project)
        expect {
          post :create, params: { id: pp.id, required_project_id: required_pp }
        }.to change(ProjectRequirement, :count).by(1)
        expect {
          post :create, params: { id: pp.id, required_project_id: required_pp }
        }.to change(ProjectRequirement, :count).by(0)
    ...
    context "destroy requirement" do
      it "should delete the requirement" do
        ...
        ProjectRequirement.create(
          ...
          required_project_id: required_pp.id
        )
        expect {
          delete :destroy, params: { id: ProjectRequirement.last.id }
        }.to change(ProjectRequirement, :count).by(-1)
        expect(response).to redirect_to proficient_project_path(pp.id)
      end
    end
