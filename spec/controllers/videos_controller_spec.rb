  ...
  describe "GET /index" do
    context "logged as admin" do
      it "should return 200 response" do
        get :index
        expect(
          @controller.instance_variable_get(:@videos_pp).count +
            @controller.instance_variable_get(:@videos_lm).count
        ).to eq(Video.count)
  ...
  describe "GET /new" do
    context "logged as admin" do
      it "should return a 200" do
        get :new
        expect(
          @controller.instance_variable_get(:@proficient_projects).count
        ).to eq(ProficientProject.count)
        expect(response).to have_http_status(:success)
      end
    end
  end
  ...
  describe "POST /create" do
    context "logged as admin" do
      it "should create a video and redirect" do
        ...
        expect { post :create, params: { video: video_params } }.to change(
          Video,
          :count
        ).by(1)
