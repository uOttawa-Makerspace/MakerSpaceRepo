  ...
  describe 'POST /create' do
    context 'logged as admin' do
      it 'should create an option and redirect' do
        ...
        expect { post :create, params: {job_option: params} }.to change(JobOption, :count).by(1)
  ...
  describe 'PATCH /update' do
    context 'logged as admin' do
      it 'should update the option' do
        patch :update, params: {id: @option.id, job_option: {name: "abc123"} }
        expect(response).to redirect_to settings_job_orders_path
  ...
  describe "DELETE /destroy" do
    context 'logged as admin' do
      it 'should destroy the option' do
        expect { delete :destroy, params: {id: @option.id} }.to change(JobOption, :count).by(-1)
        expect(response).to redirect_to settings_job_orders_path
      end
    end
  end
