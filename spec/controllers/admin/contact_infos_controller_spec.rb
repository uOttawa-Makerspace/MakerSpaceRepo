  ...
  describe "GET /index" do
    context "logged as admin" do
      it "should return 200 response" do
        ...
        expect(@controller.instance_variable_get(:@contact_infos).count).to eq(
          2
        )
      end
    end
  ...
  describe "POST /create" do
    context "logged as admin" do
      it "should create an contact info and redirect" do
        ...
        expect {
          post :create, params: { contact_info: contact_info_params }
        }.to change(ContactInfo, :count).by(1)
        expect(flash[:notice]).to eq(
          "You've successfully created a new Contact Info !"
        )
  ...
  describe "DELETE /destroy" do
    context "logged as admin" do
      it "should destroy the contact info" do
        expect { delete :destroy, params: { id: @contact1.id } }.to change(
          ContactInfo,
          :count
        ).by(-1)
        expect(response).to redirect_to admin_contact_infos_path
